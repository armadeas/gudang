...
class Breadcrumbs {
	...
	{	
		...
		$this->crumb_icon = $this->ci->config->item('crumb_icon');
		...
		if ($this->breadcrumbs) {
			...
			foreach ($this->breadcrumbs as $key => $crumb) {
				if (end(array_keys($this->breadcrumbs)) == $key) {
					...
					$output .= $this->crumb_open.$this->crumb_icon.'<a href="' . $crumb['href'] . '">' . $crumb['page'] . '</a> '.$this->crumb_divider.$this->crumb_close;
				}
				 else {
